...
public class FarthestPairConvexHullOperation
{
	public static JavaRDD<Coordinate> geometryConvexHull(String inputLocation, String outputLocation) throws ClassNotFoundException
	{
		...
		JavaRDD<Coordinate> partitionMapping = lines.mapPartitions( new FlatMapFunction<Iterator<String>, Coordinate>() 
				{
					...
					public Iterable<Coordinate> call(Iterator<String> coordinateIterator) throws Exception 
					{
						...
						for(;coordinateIterator.hasNext();)
						{
							...
							if(FarthestPairConvexHullOperation.isNumber(tempCoordArray[0]) && FarthestPairConvexHullOperation.isNumber(tempCoordArray[1]))
							{
